...
if __name__ == "__main__":
    ...
    model_name = input("사용할 모델 파일 이름 (model/ 폴더 내, 기본: model_v1.pth): ").strip()
    if not model_name:
    ...
    print("3. MCTS vs MCTS (시뮬레이션 횟수 다르게)")
    print("4. 사람 vs 사람")
    ...
    if mode == '2':
        ...
        player1 = MCTSPlayer(model_path=MODEL_PATH, simulations=400)
        player2 = MCTSPlayer(model_path=MODEL_PATH, simulations=100)
    elif mode == '4':
        player1 = HumanPlayer()
        player2 = HumanPlayer()
        ...
        player1 = HumanPlayer()
        player2 = MCTSPlayer(model_path=MODEL_PATH, simulations=200)
